...
export default Ember.Controller.extend({
  ...
  industryList: [
    ...
    {label: 'Apparel & Sporting Goods', value: 'Apparel & Sporting Goods'},
  ...
  topicList: [
    {label: 'About Export.gov', value: 'About Export.gov'},
    ...
    {label: 'Expand Your Exports', value: 'Expand Your Exports'},
    {label: 'Export Assistance', value: 'Export Assistance'},
    {label: 'Export Basics', value: 'Export Basics'},
    {label: 'Export Documents and Forms', value: 'Export Documents and Forms'},
    {label: 'Export Licenses', value: 'Export Licenses'},
    {label: 'Finance Your Exports', value: 'Finance Your Exports'},
    {label: 'Free Trade Agreements', value: 'Free Trade Agreements'},
    {label: 'Freight Forwarder', value: 'Freight Forwarder'},
    {label: 'Getting Paid', value: 'Getting Paid'},
    ...
    {label: 'International Sales and Marketing', value: 'International Sales and Marketing'},
    ...
    {label: 'Personal Shipments', value: 'Personal Shipments'},
    {label: 'Product Labeling', value: 'Product Labeling'},
    {label: 'Safe Harbor - U.S.-European Union', value: 'Safe Harbor - U.S.-European Union'},
    {label: 'Safe Harbor - U.S.-Swiss', value: 'Safe Harbor - U.S.-Swiss'},
    {label: 'Sales and Promotion', value: 'Sales and Promotion'},
    {label: 'Schedule B and HS Number', value: 'Schedule B and HS Number'},
    {label: 'Selling Online', value: 'Selling Online'},
    {label: 'Shipping', value: 'Shipping'},
    {label: 'Tariffs and Import Fees', value: 'Tariffs and Import Fees'},
    {label: 'TPCC', value: 'TPCC'},
    {label: 'Trade Barriers', value: 'Trade Barriers'},
    {label: 'Trade Data', value: 'Trade Data'},
